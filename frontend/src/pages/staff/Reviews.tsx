...
import { Star, Trash2, AlertCircle, Send } from 'lucide-react';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
const StaffReviewsPage = () => {
  ...
  const handleDelete = async () => {
    if (!deleteId) return;
    try {
      const res = await apiCall(`/api/reviews/${deleteId}`, { method: 'DELETE' });
  ...
  return (
    <div className="space-y-6 p-6 max-w-7xl mx-auto">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 border-b pb-6">
        <div>
          <h1 className="text-3xl font-bold text-primary">Quản lý Đánh giá (Staff)</h1>
          <p className="text-muted-foreground mt-1">Tour • Điểm đến • Món ăn • Tin tức</p>
        </div>
                        ...
                        <div className="flex items-start justify-between gap-4">
                          <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                              ...
                              <div>
                                <span className="font-bold text-emerald-800">Nhân viên</span>
                      ...
                      <div className="mt-6 ml-12">
                        ...
                        >
                          <input
                            name="reply"
                            type="text"
                            placeholder="Nhập phản hồi từ Nhân viên..."
